...
public class ClassVarListValid extends ClassVarDeclList {

    private ClassVarDeclList ClassVarDeclList;
    private VarDecl VarDecl;

    public ClassVarListValid (ClassVarDeclList ClassVarDeclList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassVarListValid(\n");
